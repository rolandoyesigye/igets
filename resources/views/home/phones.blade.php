            ...
            @if($phone->isInStock())
              <form action="{{ route('cart.add') }}" method="POST" class="mt-2">
                ...
                <div class="flex flex-col gap-2 items-center">
                  ...
                  <a href="https://wa.me/256701482381?text=I'm%20interested%20in%20{{ urlencode($phone->name) }}%20priced%20at%20UGX%20{{ number_format($phone->price) }}%20is%20it%20still%20available?"
                    target="_blank"
