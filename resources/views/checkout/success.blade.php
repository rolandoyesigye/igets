...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
    ...
    <p class="text-lg text-gray-700 mb-6">Thank you for your purchase. Your order <span class="font-semibold">#{{ $order->order_number }}</span> has been received and is being processed.</p>
    ...
    <a href="{{ route('home') }}" class="mt-8 inline-block bg-orange-500 text-white px-6 py-3 rounded-lg font-semibold hover:bg-orange-600 transition-colors duration-200">Continue Shopping</a>
</div>
